...
{
    Is(0,0,4) =
        (omegaPow[4]/80.0)*(sqr(gMagSqr) + 10.0*gMagSqr*gPow[2].z() + 5.0*gPow[4].z())
...
{
    Is(0,4) =
        (omegaPow[4]/80.0)*(sqr(gMagSqr) + 10.0*gMagSqr*gPow[2].y() + 5.0*gPow[4].y())
...
{
    Is(4) =
        (omegaPow[4]/80.0)*(sqr(gMagSqr) + 10.0*gMagSqr*gPow[2].x() + 5.0*gPow[4].x())
