...
Foam::populationBalanceSubModels::aggregationKernels:: coalescenceEfficiencyKernels::constant::constant
(
...
coalescenceEfficiencyKernels::constant::~constant()
{}
...
Foam::scalar
Foam::populationBalanceSubModels::aggregationKernels::
coalescenceEfficiencyKernels::constant::Pc
(
    const scalar& d1,
    const scalar& d2,
    const vector& Ur,
